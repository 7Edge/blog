# Generated by Django 2.0.7 on 2018-08-07 04:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=32, verbose_name='博客站点名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myblog.Article', verbose_name='文章')),
                ('parent_comment_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myblog.Comment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myblog.Tag', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='article',
            name='category',
        ...
        migrations.AddField(
            model_name='article',
            name='tag',
            field=models.ManyToManyField(through='myblog.Article2Tag', to='myblog.Tag'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='blog',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='myblog.Blog'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='groups',
